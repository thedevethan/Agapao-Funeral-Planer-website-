        ...
        <div class="flex flex-col my-6 space-y-6 md:space-y-0 md:space-x-6 md:flex-row md:my-0">
            ...
            <div class="bg-slate-700 rounded-xl text-white">
                ...
                <div class="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
                    ...
                    <div class="flex justify-center">
                        <a href="#" class="inline-block px-10 py-3 my-6 text-center border
                            border-violet-600 rounded-lg hover:bg-violet-800
                            hover:border-violet-800 duration-200">Purchase</a>
                    </div>
                </div>
                ...
                <!-- Lower Container -->
                <div class="p-8 mx-3 mb-3 rouded-b-xl bg-slate-800">
                    <!-- List Container -->
                    <div class="flex flex-col space-y-2">
                        ...
                        <div class="flex justify-center">
                            ...
                            <span class="text-sm ml-l">100 GB of storage</span>
                        </div>
                        <!-- List Item 2 -->
                        <div class="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" stroke-width="2"
                            ...
                            <span class="text-sm ml-l">Option to add members</span>
                        </div>
                        <!-- List Item 3 -->
                        <div class="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" stroke-width="2"
                            ...
                            <span class="text-sm ml-l">Extra member benefits</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-violet-600 rounded-xl text-white">
                ...
                <div class="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
                    ...
                    <div class="flex justify-center">
                        <a href="#" class="inline-block px-10 py-3 my-6 text-center
                ...
                <div class="p-8 mx-3 mb-3 rouded-b-xl bg-slate-800">
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <div class="flex justify-center">
                            ...
                            <span class="text-sm ml-l">200 GB of storage</span>
                        </div>
                        <!-- List Item 2 -->
                        <div class="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" stroke-width="2"
                ...
                <div class="p-8 mx-3 mb-3 rouded-b-xl bg-slate-800">
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <div class="flex justify-center">
                            ...
                            <span class="text-sm ml-l">2 TB of storage</span>
                        </div>
                        <!-- List Item 2 -->
                        <div class="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" stroke-width="2"
